...
@can('access_reports')
    <li class="c-sidebar-nav-item c-sidebar-nav-dropdown {{ request()->routeIs('*-report.index') ? 'c-show' : '' }}">
        ...
        <ul class="c-sidebar-nav-dropdown-items">
            ...
            <li class="c-sidebar-nav-item">
                <a class="c-sidebar-nav-link {{ request()->routeIs('sales-category-report.index') ? 'c-active' : '' }}" href="{{ route('sales-category-report.index') }}">
                    <i class="c-sidebar-nav-icon bi bi-clipboard-data" style="line-height: 1;"></i> Sales Category Report
                </a>
            </li>
            <li class="c-sidebar-nav-item">
